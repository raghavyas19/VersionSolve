...
import { adminSendOtp, getAdminCsrfToken } from '../utils/api';
...
const AdminForgotPasswordPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await adminSendOtp(email, csrfToken, true); // true = forPasswordReset
      navigate('/admin/verify-otp', { state: { email, forPasswordReset: true } });
    } catch (err: any) {
      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700">
          ...
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Admin Forgot Password</h2>
