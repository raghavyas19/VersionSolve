...
const AdminNavbar: React.FC<AdminNavbarProps> = ({ admin }) => {
  ...
  return (
    <nav className="w-full flex items-center justify-between px-6 py-3 border-b bg-white dark:bg-gray-800 shadow-sm" style={{ minHeight: '60px' }}>
