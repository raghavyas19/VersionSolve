      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-lg font-semibold text-gray-900 dark:text-white">{problem.title}</h1>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              disabled={isRunning}
              className="flex items-center space-x-2 px-4 py-1.5 bg-green-600 text-white rounded hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm"
            >
              {isRunning ? <LoadingSpinner size="sm" /> : <Play className="h-4 w-4" />}
              <span>Run</span>
            </button>
            
            <button className="flex items-center space-x-2 px-4 py-1.5 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors text-sm">
